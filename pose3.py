...
parser.add_argument('--proto', help='Path to .prototxt',
                    default="models/pose/mpi/pose_deploy_linevec_faster_4_stages.prototxt")
parser.add_argument('--model', help='Path to .caffemodel', default="models/pose/mpi/pose_iter_160000.caffemodel")
parser.add_argument('--dataset', help='Specify what kind of model was trained. '
                                      'It could be (COCO, MPI, HAND) depends on dataset.', default="MPI")
